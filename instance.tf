...
resource "oci_core_instance" "instance" {
  ...
  shape               = var.shape_amd # var.shape_arm para usar o shape ARM. Configue no arquivo de variáveis o tamanho de CPU e MEM.

  # shape_config {                            #
  #    ocpus         = var.shape_arm_cpus    # Descomente este bloco ao uso com o shape ARM.
  ...
  source_details {
    ...
    # source_id   = data.oci_core_images.oraclelinux.images.0.id # Comente a entrada acima e descomente esta para usar a imagem do Oracle Linux 8.x.
